<div id="mapHeading">
    ...
    <div id="buttonrow">
        ...
        <div class="topbutton hidden">
        <select id="codechoice" name="codechoice" style="border:1px solid #000000;width:60px;" onchange="codeID=parseInt(this.options[this.selectedIndex].value);setCode();">
        ...
        <div class="topbutton">
            <form action="#">
                ...
                <g:message code="zoom.level"/>:<input type="text" class="btn btn-xs" size="5" name="myzoom" id="myzoom" value="" class="form-control"/>
        ...
        <div class="topbutton">
           <g:link controller="map" action="upload" class="btn btn-primary btn-xs"><i class="fa fa-upload"></i> <g:message code="upload.label"/></g:link>
        </div>


        <div class="topbutton">
            <span class="btn btn-info btn-xs">
                <g:link controller="map" action="communityXml" params="${[name:currentEntry?.name]}" target="newWin"><i class="fa fa-file-powerpoint-o"></i> <g:message code="kml.label" args="${[currentEntry.name]}"/>
                </g:link>
            </span>
        </div>
...
<div class="topbutton">
    <input type="text" style="border: 1px solid #000000;" size="30" name="address"  id="addressInput" placeholder="${g.message(code:'address.label')}" >
    ...
    <div id="polylineoptions">
        ...
        <div class="clear"></div>
        <div>
            <a class="oklink" href="javascript:polylinestyle(0)"><g:message code="saveChanges.label"/></a>
        </div>
        <div style="margin-top:5px">
            <a class="oklink" href="javascript:polylinestyle(1)"><g:message code="saveNewStyle.label"/></a>
        </div>
        <div style="width:100%; text-align:center; margin-top:5px">
            <input type="button" class="buttons" name="backwards" id="backwards" value="${g.message(code:'previous.label')}" onclick="stepstyles(-1);"/>
            <g:message code="style.label"/> <span id="stylenumberl">1 </span>
            <input type="button" class="buttons" name="forwards" id="forwards" value="${g.message(code:'next.label')}" onclick="stepstyles(1);"/>
        </div>
    </div>
    <div id="polygonoptions">
        ...
        <div class="clear"></div>
        <div>
            <a class="oklink" href="javascript:polygonstyle(0)"><g:message code="saveChanges.label"/></a>
        </div>
        <div style="margin-top:5px">
            <a class="oklink" href="javascript:polygonstyle(1)"><g:message code="saveNewStyle.label"/></a>
        </div>
        <div style="width:100%; text-align:center; margin-top:5px">
            <input type="button" class="buttons" name="backwards" id="backwards" value="${g.message(code:'previous.label')}" onclick="stepstyles(-1);"/>
    ...
    <div id="circleoptions">
        ...
        <div class="clear"></div>
        <div>
            <a class="oklink" href="javascript:circlestyle(0)"><g:message code="saveChanges.label"/></a>
        </div>
        <div style="margin-top:5px">
            <a class="oklink" href="javascript:circlestyle(1)"><g:message code="saveNewStyle.label"/></a>
        </div>
        <div style="width:100%; text-align:center; margin-top:5px">
            <input type="button" class="buttons" name="backwards" id="backwards" value="${g.message(code:'previous.label')}" onclick="stepstyles(-1);"/>
    ...
    <div id="markeroptions">
        <div id="iconimages">
            <table>
                ...
                <tr>
                    <td><input type="button" name="button" value="${g.message(code:'use.label')}" onclick='iconoptions("${asset.image(src: "/map/red-dot.png")}");' />
                    </td>
                    <td><input type="button" name="button" value="${g.message(code:'use.label')}" onclick='iconoptions("${asset.image(src: "/map/orange-dot.png")}");' />
                    </td>
                    <td><input type="button" name="button" value="${g.message(code:'use.label')}" onclick='iconoptions("${asset.image(src: "/map/yellow-dot.png")}");' />
                    </td>
                    <td><input type="button" name="button" value="${g.message(code:'use.label')}" onclick='iconoptions("${asset.image(src: "/map/green-dot.png")}");' />
                    </td>
                    <td><input type="button" name="button" value="${g.message(code:'use.label')}" onclick='iconoptions("${asset.image(src: "/map/blue-dot.png")}");' />
                    </td>
                    <td><input type="button" name="button" value="${g.message(code:'use.label')}" onclick='iconoptions("${asset.image(src: "/map/purple-dot.png")}");' />
                    </td>
                    <td><input type="button" name="button" value="${g.message(code:'use.label')}" onclick='iconoptions("${asset.image(src: "/map/red.png")}");' />
                    </td>
                    <td><input type="button" name="button" value="${g.message(code:'use.label')}" onclick='iconoptions("${asset.image(src: "/map/orange.png")}");' />
                    </td>
                    <td><input type="button" name="button" value="${g.message(code:'use.label')}" onclick='iconoptions("${asset.image(src: "/map/yellow.png")}");' />
                    </td>
                    <td><input type="button" name="button" value="${g.message(code:'use.label')}" onclick='iconoptions("${asset.image(src: "/map/green.png")}");' />
                    </td>
                    <td><input type="button" name="button" value="${g.message(code:'use.label')}" onclick='iconoptions("${asset.image(src: "/map/blue.png")}");' />
                    </td>
                    <td><input type="button" name="button" value="${g.message(code:'use.label')}"  onclick='iconoptions("${asset.image(src: "/map/purple.png")}");' />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><input type="button" name="button" value="${g.message(code:'use.label')}" onclick='iconoptions("${asset.image(src: "/map/dd-start.png")}");' />
                    </td>
                    ...
                    <td><input type="button" name="button" value="${g.message(code:'use.label')}" onclick='iconoptions("${asset.image(src: "/map/marker_yellowA.png")}");' />
                    </td>
                    <td><input type="button" name="button" value="${g.message(code:'use.label')}" onclick='iconoptions("${asset.image(src: "/map/marker_greenA.png")}");' />
                    </td>
                    <td><input type="button" name="button" value="${g.message(code:'use.label')}" onclick='iconoptions("${asset.image(src: "/map/marker_brownA.png")}");' />
                    </td>
                    <td><input type="button" name="button" value="${g.message(code:'use.label')}" onclick='iconoptions("${asset.image(src: "/map/marker_purpleA.png")}");' />
                    </td>
                    <td><input type="button" name="button" value="${g.message(code:'use.label')}" onclick='iconoptions("${asset.image(src: "/map/marker_blackA.png")}");' />
                    </td>
                    <td><input type="button" name="button" value="${g.message(code:'use.label')}" onclick='iconoptions("${asset.image(src: "/map/marker_greyA.png")}");' />
                    </td>
                    <td><input type="button" name="button" value="${g.message(code:'use.label')}" onclick='iconoptions("${asset.image(src: "/map/marker_whiteA.png")}");'  />
                    </td>
                </tr>
            </table>
            <table>
                ...
                <tr>
                    <td><input type="button" name="button" value="${g.message(code:'use.label')}" onclick='iconoptions("${asset.image(src: "/map/marker_20_red.png")}");'  />
                    </td>
                    <td><input type="button" name="button" value="${g.message(code:'use.label')}" onclick='iconoptions("${asset.image(src: "/map/marker_20_orange.png")}");' />
                    </td>
                    <td><input type="button" name="button" value="${g.message(code:'use.label')}"  onclick='iconoptions("${asset.image(src: "/map/marker_20_yellow.png")}");'  />
                    </td>
                    <td><input type="button" name="button" value="${g.message(code:'use.label')}"  onclick='iconoptions("${asset.image(src: "/map/marker_20_green.png")}");' />
                    </td>
                    <td><input type="button" name="button" value="${g.message(code:'use.label')}"  onclick='iconoptions("${asset.image(src: "/map/marker_20_brown.png")}");'  />
                    </td>
                    <td><input type="button" name="button" value="${g.message(code:'use.label')}"  onclick='iconoptions("${asset.image(src: "/map/marker_20_blue.png")}");'  />
                    </td>
                    <td><input type="button" name="button" value="${g.message(code:'use.label')}"  onclick='iconoptions("${asset.image(src: "/map/marker_20_purple.png")}");'  />
                    </td>
                    <td><input type="button" name="button" value="${g.message(code:'use.label')}"  onclick='iconoptions("${asset.image(src: "/map/marker_20_black.png")}");' />
                    </td>
                    <td><input type="button" name="button" value="${g.message(code:'use.label')}"  onclick='iconoptions("${asset.image(src: "/map/marker_20_white.png")}");'  />
                    </td>
                </tr>
            </table>
            <table>
                ...
                <tr>
                    <td>
                        <span class="btn btn-default btn-xs" onclick='iconoptions("${asset.image(src: "/map/bar.png")}");'><g:message code="use.label"/></span>
                    </td>
                    <td> <span class="btn btn-default btn-xs" onclick='iconoptions("${asset.image(src: "/map/restaurant.png")}");'><g:message code="use.label"/></span>
                    </td>
                    <td> <span class="btn btn-default btn-xs" onclick='iconoptions("${asset.image(src: "/map/lodging.png")}");'><g:message code="use.label"/></span>
                    </td>
                    <td> <span class="btn btn-default btn-xs" onclick='iconoptions("${asset.image(src: "/map/golfer.png")}");'><g:message code="use.label"/></span>
                    </td>
                    <td> <span class="btn btn-default btn-xs" onclick='iconoptions("${asset.image(src: "/map/sportvenue.png")}");'><g:message code="use.label"/></span>
                    </td>
                    <td> <span class="btn btn-default btn-xs" onclick='iconoptions("${asset.image(src: "/map/planecrash.png")}");'><g:message code="use.label"/></span>
                    </td>
                    <td> <span class="btn btn-default btn-xs" onclick='iconoptions("${asset.image(src: "/map/square-compass.png")}");'><g:message code="use.label"/></span>
                    </td>
                </tr>
            </table>
        </div>
        <div id="stylestext">
            <form action="#" style="padding-top:3px; margin-top:-5px">
                ...
                <div style="margin-top:5px">
                    <a class="oklink" href="javascript:markerstyle(0)"><g:message code="saveChanges.label"/></a>
                    <a class="oklink" href="javascript:markerstyle(1)"><g:message code="saveNewStyle.label"/></a>
                </div>
                <div style="width:100%; text-align:center; margin-top:5px">
    ...
    <div id="toppers">
        ...
        &lt;<g:message code="altitudeMode.label"/>&gt;<input type="text" id="plm4" value="clampToGround" style="width:100px; border:2px solid #ccc;" /><br /><br />
           <g:message code="styleOptCr.label"/><br />
            ...
            <input type="button" name="docu" id="docu" value="${g.message(code:'save.label')}" onclick='savedocudetails();document.getElementById("toppers").style.visibility = "hidden";'/>
            <input type="button" value="${g.message(code:'close.label')}" onclick='document.getElementById("toppers").value="";document.getElementById("toppers").style.visibility = "hidden";'/>
        </form>
    </div>
    <div id="dirtoppers">
        <form action="#" class="panel-body">
            &lt;<g:message code="document.label"/>&gt;<br />
            &nbsp;&nbsp;&lt;<g:message code="name.label"/>&gt;<input type="text" id="dirdoc1" value="${g.message(code:'myDoc.label')}" style="width:345px; border:2px solid #ccc;" /><br />
        ...
        &lt;<g:message code="altitudeMode.label"/>&gt;<input type="text" id="dirplm4" value="clampToGround" style="width:100px; border:2px solid #ccc;" /><br /><br />
            ...
            <g:message code="styleOptCr.label"/><br />
            <g:message code="pressNow.label"/><br /><br />
            <input type="button" name="docu" id="docu" value="${g.message(code:'save.label')}" onclick='savedocudetails();document.getElementById("dirtoppers").style.visibility = "hidden";'/>
            <input type="button" value="${g.message(code:'close.label')}" onclick='document.getElementById("dirtoppers").value="";document.getElementById("dirtoppers").style.visibility = "hidden";'/>
        </form>
